...
**Version 1.2.** Adds an explicit scope boundary to §16.1: the goal is bounded *extension* (lifespan/capability for space and reduced physical limits), **not** individual immortality. See development history. The filename carries the version (`synthetic_body_design_V1.2`).
...
### 16.9 Expanded Sensorium — a real upgrade biological humans cannot have (new, Rev 9) `[HYBRID SYNTHESIS]`
